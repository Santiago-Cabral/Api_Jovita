...
namespace ForrajeriaJovitaAPI.Controllers
{
    ...
    public class SettingsController : ControllerBase
    {
        ...
        /// <summary>
        /// GET /api/Settings - Obtener configuraci�n tipada (p�blica)
        ...
        public async Task<ActionResult<SettingsDto>> GetSettings()
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Error al obtener configuraci�n" });
            }
        }

        /// <summary>
        /// PUT /api/Settings - Actualizar configuraci�n (solo admin)
        ...
        public async Task<IActionResult> UpdateSettings([FromBody] SettingsDto updates)
        {
            ...
            try
            {
                ...
                {
                    _logger.LogWarning("Usuario sin permisos intent� actualizar settings. Role: {Role}", userRole);
                    return Forbid();
                }
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Error al guardar configuraci�n", error = ex.Message });
            }
        }
        ...
        public async Task<IActionResult> ResetToDefaults()
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Error al resetear configuraci�n" });
            }
        }
